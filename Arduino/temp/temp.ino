...
int temp = 2;  //Pin analógico A5 del Arduino donde conectaremos el pin de datos del sensor TMP36
...
void loop()
{
  ...
  voltaje = analogRead(2) * 0.004882814;  //Con esta operación lo que hacemos es convertir el valor que nos devuelve
